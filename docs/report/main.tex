...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \vspace{13mm}
    {\Large{\bf Re-Engineering AE-XAD with Vision Transformers: An Analysis of Architectural Compatibility for Explainable Anomaly Detection}}\\	
     \vspace{7mm}
    \end{center}
    \vspace{18mm}
    \noindent
