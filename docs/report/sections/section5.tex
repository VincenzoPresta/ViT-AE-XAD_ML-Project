...
Questa scelta è deliberata e consente di attribuire le differenze di
prestazioni osservate principalmente alla modifica dell’encoder, piuttosto che
a effetti introdotti da strategie di augmentazione complesse.

\subsection{Funzione di perdita}

In tutti gli esperimenti è stata utilizzata la funzione di perdita AE-XAD
