...
all’architettura dell’encoder. La pipeline di augmentation proposta in \cite{angiulli2025aexad}
...
originale, implementata fedelmente secondo la formulazione proposta nel paper \cite{angiulli2025aexad}. 
La loss è definita a livello pixel-wise e combina il contributo dei
