...
pipeline di ricostruzione, scoring e localizzazione. L’obiettivo era valutare 
l’impatto di un diverso encoder all’interno di un paradigma di anomaly detection basato su
...
nel setting congelato, dove i valori di X-AUC rimangono relativamente elevati per
...
anche se non ottimali per la localizzazione pixel-wise, conservano una certa
...
anomale, in alcuni casi fino alla quasi soppressione dello stesso. Questo comportamento
...
sub-ottimale, bensì a una incompatibilità tra la natura delle
...
meccanismi di localizzazione e decisione coerenti con rappresentazioni globali, 
superando l’ipotesi di una sogliatura statistica unica basata sulla concentrazione 
locale dell’errore, al fine di riallineare le proprietà rappresentazionali del 
modello con gli obiettivi del task.
