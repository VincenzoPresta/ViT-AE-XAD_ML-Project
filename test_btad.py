...
for i in range(1, 4):
    ...
    ret_path = f'results/{dataset}_final_f2/{s}'
    ...
    X_train, Y_train, X_test, Y_test, GT_train, GT_test = extract_dataset(dataset_path, na, seed=s)
